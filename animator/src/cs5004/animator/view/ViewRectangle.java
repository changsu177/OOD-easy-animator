...
/**
 * This class represents a rectangle in view.
 */
public class ViewRectangle extends AbstractViewShapes {

  /**
   * This is the constructor for the viewRectangle class.
   *
   ...
   */
  public ViewRectangle(String name, int x, int y, int width, int height, Color color, int
          atime, int dtime) {
