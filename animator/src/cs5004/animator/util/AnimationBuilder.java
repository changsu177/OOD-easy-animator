...
/**
 * This is an AnimationBuilder interface.
 *
...
public interface AnimationBuilder<Doc> {
   ...
   * @return This {@link AnimationBuilder}
   * @throws IllegalArgumentException if the input shape type is not defined.
   */
  AnimationBuilder<Doc> declareShape(String name, String type) throws IllegalArgumentException;
